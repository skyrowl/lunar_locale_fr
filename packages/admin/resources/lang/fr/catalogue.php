...
return [
    ...
    'collections.groups.delete.strapline' => 'Voulez-vous vraiment supprimer ce groupe de collections?',
    ...
    'collections.groups.move.alert' => 'Ceci déplacera :source vers :target.',
    'collections.groups.move.btn' => 'Déplacer la collection',
    'collections.groups.node.make_root' => 'En faire la racine',
    ...
    'collections.groups.no_groups' => 'Il semble que vous n\'ayez configuré aucun groupe de collections.',
    ...
    'collections.create.btn' => 'Créer une collection',
    'collections.delete.title' => 'Supprimer la collection',
    'collections.delete.btn' => 'Supprimer la collection',
    'collections.delete.child.warning' => 'Cette collection a :count collections enfants, celles-ci seront également perdues.',
    'collections.delete.root.warning' => 'Voulez-vous vraiment supprimer cette collection?',
    ...
    'collections.show.sort.custom' => 'Personnaliser',
    'collections.show.no_products' => 'Cette collection n\'a aucun produit associé.',
    'collections.show.no_children' => 'Cette collection n\'a pas de collections enfants, celles-ci peuvent être ajoutées via la page de l\'arborescence des collections.',
    'collections.associate_to_other_products' => 'Choisir les produits à associer et associer à ce produit.',
    'collections.static_collections' => 'Collections statiques',
    'collections.summer_seasonal' => 'Summer Seasonal',
    /**
     * Product show.
     */
    'products.show.back_link_title' => 'Retourner à la liste des produits',
    'products.show.save_btn' => 'Enregistrer le produit',
    'products.show.no_channel_availability' => 'Ce produit n\'est pdisponible sur aucun canaux.',
    'products.show.delete_title' => 'Supprimer le produit',
    'products.show.delete_strapline' => 'Ceci enverra le produit dans la corbeille, vous pourrez le restaurer plus tard',
    'products.show.restore_strapline' => 'Restaurer ce produit pour qu\'il soit disponible sur votre boutique.',
    'products.show.delete_btn' => 'Confirmer la suppression',
    ...
    'product-variants.delete_confirm.btn' => 'Supprimer la variante du produit',
    ...
    'product-types.attribute.search.empty' => 'Il semble que vous n\'ayez plus d\'attributs disponibles.',
    'product-types.attribute.search.no_results' => 'Impossible de trouver les attributs correspondant à ":search"',
    ...
    'product-types.show.delete.disabled_message' => 'Vous ne pouvez pas supprimer un type de produit auquel des produits sont attachés.',
    ...
    'product-types.attribute.no_attributes' => 'Il n\'y a pas d\'attributs à sélectionner dans ce groupe',
    /**
     * Brands.
     */
    'brands.index.title' => 'Marques',
    'brands.create.title' => 'Créer une marque',
    'brands.show.back_link_title' => 'Revenir aux marques',
    /**
     * Customers.
     */
    'customers.index.title' => 'Clients',
    'customers.index.placeholder' => 'Rechercher des clients',
    ...
    'customer.dashboard.returning_customers' => 'Clients connus',
    'customer.dashboard.no_of_orders' => 'No. de commandes',
    'customer.dashboard.turnover' => 'Chiffre d\'affaires',
    'customer.dashboard.sales_performance' => 'Performance des ventes',
    'customer.dashboard.customer_group_orders' => 'Commandes par groupes de client',
    'customer.dashboard.top_selling_products' => 'Produits les plus vendus',
    /**
     * Customer Groups Editing.
     */
    'editing.customer-groups.select_groups' => 'Sélectionnez pour quels groupes de clients ce produit est disponible.',
    'editing.customer-groups.publish_on' => 'Ce produit doit être publié le',
    'editing.customer-groups.schedule_availability' => 'Programmer la disponibilité',
    /**
     * Orders.
     */
    'orders.show.customer_reference' => 'Référence client',
    'orders.show.shipping_option' => 'Options de livraison',
     ...
     * Stock.
     */
    'stock' => 'Référence client',
    /**
     * Addons.
     */
    'addons.show.addon_details' => 'Détails du module',
